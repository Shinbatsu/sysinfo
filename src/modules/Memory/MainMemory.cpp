...
MainMemory::MainMemory(MainMemory const& src) { *this = src; }
...
const float& MainMemory::getGraphMin(void) const { return this->_min; }

const float& MainMemory::getGraphMax(void) const { return this->_max; }

const std::map<std::string, std::deque<float>>& MainMemory::getGraphs(void) const {
    return this->_graphs;
}

const std::map<std::string, std::string>& MainMemory::getData(void) const { return this->_data; }

const std::string& MainMemory::getName(void) const { return this->_name; }

void MainMemory::setName(std::string name) { this->_name = name; }
